...
import { isPlatformAdmin, FOUNDING_ADMIN_EMAIL } from '@/lib/platform-admin';
...
export async function DELETE(req: NextRequest) {
  ...
  if (email === FOUNDING_ADMIN_EMAIL) {
    return NextResponse.json({ error: 'cannot_remove_founder' }, { status: 400 });
  }
